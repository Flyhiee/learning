...
document.getElementById("multiplication").innerHTML = "The multiplication of " + num1 + " and " + num2 + " is " + product;
document.getElementById("division").innerHTML = "The division of " + num1 + " and " + num2 + " is " + quotient;
